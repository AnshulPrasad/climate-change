...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'fallback-key-for-local-dev-only')
...
MIDDLEWARE = [
    ...
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware', # it is giving error on hugging face space
]
...
TIME_ZONE = 'Asia/Kolkata' # Changed time zone to local
