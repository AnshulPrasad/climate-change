...
SCHEMA_PATH = Path(__file__).resolve().parent.parent / "schemas" / "berkeley_earth.json"

class BerkeleyEarthFormFactory:
    ...
    def create_form(cls, dataset_id: str, data: dict = None) -> forms.Form:
        ...
        return type(f"Berkeley_{dataset_id.replace('-', '_').title()}_Form", (forms.Form,), fields)(data=data)