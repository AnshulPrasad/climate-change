...
SCHEMA_PATH = Path(__file__).resolve().parent.parent / "schemas" / "esgf.json"

class ESGFFormFactory:
    ...
    def create_form(cls, dataset_id: str, data: dict = None) -> forms.Form:
        ...
        return type(f"ESGF_{dataset_id.replace('-', '_').title()}_Form", (forms.Form,), fields)(data=data)